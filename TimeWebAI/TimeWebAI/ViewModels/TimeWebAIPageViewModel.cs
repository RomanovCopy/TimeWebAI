...
{
    public class TimeWebAIPageViewModel:ViewModelBase, ITimeWebAIPageViewModel
    {
        private readonly ITimeWebAIPageModel model;

        public TimeWebAIPageViewModel(ITimeWebAIPageModel model)
        {
            this.model = model;
